    ...
    <div class="overflow-y-auto py-2" wire:scroll style="height: calc(100vh - 160px)">
        <ul class="list ms-6">
            <li class="py-3">
                ...
                <ul class="mt-2 ">
                    <li class="ps-3 border-l-2 border-sky-950 hover:border-sky-400 transition ease-in-out duration-400">
                        <a wire:navigate href="{{route('student.dashboard')}}" class="p-2 w-100 flex items-center gap-3 text-slate-400 hover:text-sky-400">
            ...
            <li class="py-3">
                ...
                <ul class="mt-2">
                    <li class="ps-3 border-l-2 border-sky-950 hover:border-sky-400 transition ease-in-out duration-400">
                        <a wire:navigate href="{{ route('student.logout') }}" class="p-2 w-100 flex items-center gap-3 text-slate-400 hover:text-sky-400">
                            <div class="p-2 rounded-lg bg-slate-800">
