                    ...
                    <div class="p-5 absolute bottom-2 left-0 w-full">
                        ...
                        @if ($collection->status == 1)
                            <div class="mt-3 flex justify-end">
                                <a wire:navigate href="{{route('student.subject', ['evaluate' => $collection->id, 'semester' => $collection->semester])}}" class=" bg-blue-100 text-blue-800 p-2 px-4 text-sm font-bold rounded-lg">Open</a>
                            </div>
                        @else
                            <div class="mt-3 flex justify-end">
