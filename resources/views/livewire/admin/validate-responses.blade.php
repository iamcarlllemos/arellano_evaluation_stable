    ...
    <div class="bg-white border shadow rounded-lg mt-8 sm:p-5">
        <div class="mb-4">
            <div class="p-4 text-sm text-blue-800 border-t border-r border-l rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400">
                <h1 class="text-1xl font-bold uppercase">Student Information</h1>
            </div>
            <div class="bg-white p-4 border shadow-lg rounded-b text-sm font-medium">
                <ul>
                    ...
                    <li>Academic Stage: {{
                        to_ordinal($result_view['student']->year_level, 'year')
                        }}
                    </li>
                </ul>
            </div>
            ...
            function chart_se(elem) {
                const options = {
                    ...
                    series: [{
                        data: [{
                            x: 'Already responded',
                            y: {{$result_view['evaluation_result']['respondents']['total_respondents']}},
                        }, {
                            x: 'Not yet responded',
                            y: {{$result_view['evaluation_result']['respondents']['respondents']}},
                        }, {
                            x: 'Total respondents',
                            y: {{$result_view['evaluation_result']['respondents']['not_responded']}},
                        }]
                    }],
